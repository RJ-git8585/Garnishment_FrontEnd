              ...
              <table className="table-auto border-collapse border border-gray-300 w-full text-sm">
                ...
                <tbody>
                  {calculationResult.results.map((result, index) => (
                    <tr key={index}>
                      <td className="border border-gray-300 px-4 py-2 text-right">{result.disposable_earning}</td>
                      <td className="border border-gray-300 px-4 py-2 text-right">{result.allowable_disposable_earning}</td>
                      <td className="border border-gray-300 px-4 py-2 text-right">{result.total_mandatory_deduction}</td>
